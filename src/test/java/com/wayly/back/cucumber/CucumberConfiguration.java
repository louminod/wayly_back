...
import com.wayly.back.WaylybackApp;
import com.wayly.back.cucumber.CucumberConfiguration.CucumberRestTemplateConfiguration;
...
@SpringBootTest(classes = { WaylybackApp.class, CucumberRestTemplateConfiguration.class }, webEnvironment = WebEnvironment.RANDOM_PORT)
