package com.wayly.back.shared.collection.domain;
...
@UnitTest
class WaylybackCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class WaylybackCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = WaylybackCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = WaylybackCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class WaylybackCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = WaylybackCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = WaylybackCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class WaylybackCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = WaylybackCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = WaylybackCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class WaylybackMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = WaylybackCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = WaylybackCollections.immutable(input);
